...
public class BatchAddUserServiceImpl implements IBatchAddUserService {
	...
	public HttpResult batchAddUser(BatchAddUserDomain tt, Long businessPlaceCode, String customerNo,
		...
		meterAssetsDomain.setFuncKindCode("9");
		meterAssetsDomain.setPowerKindCode("10");
		meterAssetsDomain.setFixedAssetsFlag("1");
		...
		meterAssetsDomain.setAccuLevelCode("13");
		meterAssetsDomain.setPhaseLine("0");
		meterAssetsDomain.setTsFlag("0");
        ...
        meterMeterAssetsRelDomain.setFunctionCode("1");
        meterMeterAssetsRelDomain.setPowerDirection("1");
        ...
        meterReplaceDomain.setFunctionCode("1");
        meterReplaceDomain.setPowerDirection("1");
